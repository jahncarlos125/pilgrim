...
export default function ProductDetails() {
  function renderType(type: 'audiobook'|'ebook'){
    if(type === 'ebook'){
      return (
        <svg xmlns="http://www.w3.org/2000/svg" name='E-book' className="absolute top-2 left-2 h-10 w-10 stroke-current stroke-2 text-pilgrim" fill="none" viewBox="0 0 24 24">
          <path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
        </svg>
      )
    }
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="absolute top-2 left-2 h-10 w-10 stroke-current stroke-2 text-pilgrim" fill="none">
      ...
      <div className="flex flex-col md:flex-row m-10">
        <div className='flex-shrink'>
          <figure className='rounded-xl relative'>
            <img className='object-contain rounded-lg' src="https://api.thepilgrim.com.br/media/covers/Arte_capa_Crist%C3%A3os_e_suas_m%C3%A3es-2_l6HhpuI.jpg" alt="" />
            {renderType('ebook')}
        ...
        <div className='flex flex-col flex-1 justify-center pt-2 md:ml-5'>
          <p className="text-3xl md:text-5xl my-1.5 text-pilgrim text-center md:text-left">
            Cristãos e suas maes
          </p>
          ...
          <p className='text-justify mt-5'>
            <span className='font-bold'>Editora: </span> Editora Mundo Cristão
          </p>
        </div>
      </div>
    </div>
